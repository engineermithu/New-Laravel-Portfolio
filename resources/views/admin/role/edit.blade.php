                                    ...
                                    <div class="col-md-5">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ old('name') ? old('name') : $role->name }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="slug" id="slug" value="{{ old('slug') ? old('slug') : $role->slug }}"
                                            ...
                                            <div class="table table-striped table-md col-md-12">
                                                <table class="table table-striped role-create-table role-permission"
                                                    ...
                                                    @foreach($permissions as $permission)
                                                        <tr>
                                                            <td>
                                                                <span class="text-capitalize">{{($permission->attribute)}}</span>
                                                            </td>
                                                            <td>
