                                        ...
                                        <tbody>
                                            @foreach ($staffs as $key => $staff)
                                                <tr>
                                                    ...
                                                    <td>{{ $staff->phone }}</td>
                                                    <td>{{ $staff->last_login != '' ? date('M d, Y h:i a', strtotime($staff->last_login)) : '' }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($staff->is_user_banned == 1)
                                                            <div class="d-flex">
                                                                <div class="ml-1 badge badge-pill badge-danger">
                                                                    {{ __('Banned') }}</div>
                                                            </div>
                                                        @else
                                                    ...
                                                    <td>
                                                        @if (hasPermission('staff_update'))
                                                            ...
                                                            <button class="btn btn-outline-warning btn-circle delete-btn"
                                                                data-toggle="tooltip" value="{{ $staff->id }}"
                                                                onclick="editRole({{ $staff->id }})" title="Delete"
                                                        ...
                                                        @if (hasPermission('staff_delete'))
                                                            ...
                                                            <button class="btn btn-outline-danger btn-circle delete-btn"
                                                                data-toggle="tooltip" value="{{ $staff->id }}"
                                                                onclick="deleteRole({{ $staff->id }})" title="Delete"
                                                                data-original-title="{{ __('Delete') }}"><i
